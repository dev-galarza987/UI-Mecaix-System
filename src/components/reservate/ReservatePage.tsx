    ...
    const fetchStats = async () => {
      try {
        ...
        if (reservates && Array.isArray(reservates)) {
          const newStats = reservates.reduce((acc, reservate) => {
            acc.total += 1;
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg cursor-pointer hover:shadow-xl transition-shadow"
          ...
          <Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg cursor-pointer hover:shadow-xl transition-shadow"
            ...
            <CardContent className="p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Lista completa de reservaciones</p>
