...
export default function VehicleUpdateForm() {
    ...
    const fetchVehicle = async () => {
      try {
        ...
        const vehicleData: FormData = {
          board: vehicle.board.toUpperCase(),
          brand: vehicle.brand,
          model: vehicle.model,
          year: vehicle.year,
        };
  ...
  const hasChanges = () => {
    ...
    return (
      currentValues.board !== originalData.board ||
      currentValues.brand !== originalData.brand ||
      currentValues.model !== originalData.model ||
      currentValues.year !== originalData.year
    );
  };
        ...
        >
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Vehículo #{vehicleId} - Actualiza la información
            </p>
          </div>
        </motion.div>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  {hasChanges() && (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-200 dark:border-cyan-800 rounded-lg p-4"
                    >
