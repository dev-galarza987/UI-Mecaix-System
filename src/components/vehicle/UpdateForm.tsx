...
export default function VehicleUpdateForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      const vehicleData: Partial<VehicleData> = values;
  ...
  return (
    <div className="container mx-auto p-4">
      <Button variant="outline" onClick={() => navigate('/vehicles/list')} className="mb-4">
        Back to List
      </Button>
      <h1 className="text-3xl font-bold mb-6 text-primary">Edit Vehicle</h1>
      <Form {...form}>
