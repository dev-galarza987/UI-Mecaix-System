  ...
  return (
    <TooltipProvider>
      <div className="container mx-auto p-4">
        ...
        <h1 className="text-3xl font-bold mb-6 text-primary">Listar vehiculos</h1>
            ...
            <TableBody>
              {vehicles.map((vehicle) => (
                <TableRow key={vehicle.id} className="hover:bg-muted/50">
                  <TableCell className="font-mono text-muted-foreground">{vehicle.board}</TableCell>
                  ...
                  <TableCell className="text-right">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="outline" size="icon" onClick={() => navigate(`/vehicles/update/${vehicle.id}`)}>
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="destructive" size="icon" className="ml-2" onClick={() => handleDeleteClick(vehicle.id)}>
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
